...
function breakdown(data){
  ...
  c = {x: xAxis, y: vArray, type: 'bar', mode: 'lines', marker:{color:'#1b2a39'}, name: 'Violent',};//'#f58538'}, name: 'Violent',};
  d = {x: xAxis, y: pArray, type: 'bar', mode: 'lines', marker:{color:'#435c73'}, name: 'Property',};//'#2b6dbc'}, name: 'Property',};
  e = {x: xAxis, y: oArray, type: 'bar', mode: 'lines',marker:{color:'#adc1d1'}, name: 'Other',};//#dad3cc'}, name: 'Other',};
